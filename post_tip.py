...
prompt = """
Write a short, engaging LinkedIn post sharing a highly practical Google Cloud Platform (GCP) tip , trick, or best practic
on Bigquery, Composer, Dataflow topics. It should be friendly and should not look like ai generated. 
Include:
- A catchy hook.
